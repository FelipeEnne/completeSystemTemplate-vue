    ...
    <div class="article-admin">
       ...
       <b-form>
          <input id="article-id" type="hidden" v-model="article.id" />
            ...
            <b-form-group label="Name:" label-form="article-name">
             ...
             <b-form-group label="Description:" label-form="article-description">
             ...
             <b-form-group  v-if="mode === 'save'"  label="Image (Url):" label-form="article-imageUrl">
